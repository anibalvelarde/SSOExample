 ...
 */
Ext.define('SSO.Security.Main', {

        singleton : true,

        //SSO server urls
        gsfWebServerUrl_POC: 'https://[your POC Authorization Server Url]/',
        gsfWebServerUrl_Dev: 'https://[your DEV Authorization Server Url]/',
        gsfWebServerUrl_QA: 'https://[your QA Authorization Server Url]/',
        gsfWebServerUrl_PROD: 'https://[your PROD Authorization Server Url]/',

        //SSO endpoints on different components
        authzEndpointUrl: '/oauth/authorize',
        authzSignOutUrl: '/SingleSignOut',

        //SSO Application Names
        authzServerName: 'AuthorizationServer',
        securityApiName: 'SSO.Security.WebApi',
        selfServiceSiteName: 'SSO.Security.SelfServiceWebsite',
