...
folder are mapped to the application's root namespace, 'SSOExtJSApp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SSOExtJSApp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SSOExtJSApp' in the same way
as `"SSOExtJSApp/sass/src"`.
